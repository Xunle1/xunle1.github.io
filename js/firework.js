...
function updateCoords (e) {
  ...
  return a.x = e, a.y = t, a.color = colors[anime.random(0, colors.length - 1)],
    ...
    a.draw = function () {
      ctx.beginPath(), ctx.arc(a.x, a.y, a.radius, 0, 2 * Math.PI, !0),
        ctx.fillStyle = a.color, ctx.fill()
    }, a
} function createCircle (e, t) {
  ...
  for (var a = createCircle(e, t), n = [], i = 0;
    i < numberOfParticules; i++) { n.push(createParticule(e, t)) } anime.timeline().add({
      ...
      targets: a, radius: anime.random(80, 160),
